...
const QuizWebsite = () => {
  ...
  const questions = [
    ...
    // Additional Questions on IEEE Format Details
    { id: 255, type: 'mcq', category: 'new', question: 'What is the main difference between IEEE and other citation styles?', options: ['IEEE uses author names in text', 'IEEE uses numbered citations in brackets', 'IEEE uses footnotes', 'IEEE uses endnotes'], correct: 1 },
    { id: 256, type: 'mcq', category: 'new', question: 'In IEEE format, where do references appear?', options: ['At the beginning', 'In footnotes', 'At the end in order cited', 'In the middle'], correct: 2 },
    { id: 257, type: 'mcq', category: 'new', question: 'How should author initials be formatted in IEEE?', options: ['No spaces between initials', 'With spaces between initials', 'Only first initial', 'No initials needed'], correct: 1 },
    { id: 258, type: 'mcq', category: 'new', question: 'What punctuation separates the title from the journal name?', options: ['Period', 'Comma', 'Semicolon', 'Colon'], correct: 1 },
    { id: 259, type: 'mcq', category: 'new', question: 'How are page numbers typically written in IEEE format?', options: ['p. 123-130', 'pages 123-130', 'pp. 123–130', '123-130 pages'], correct: 2 },
    { id: 260, type: 'mcq', category: 'new', question: 'What symbol is used between page numbers in IEEE format?', options: ['Hyphen (-)', 'En dash (–)', 'Slash (/)', 'Comma (,)'], correct: 1 },
    // Abbreviations and Formatting
    { id: 261, type: 'mcq', category: 'new', question: 'How should "Transactions" be abbreviated in IEEE references?', options: ['Trans.', 'Tran.', 'Tr.', 'Transaction'], correct: 0 },
    { id: 262, type: 'mcq', category: 'new', question: 'How should "Proceedings" be abbreviated in IEEE references?', options: ['Proceed.', 'Pro.', 'Proc.', 'Proceedings'], correct: 2 },
    { id: 263, type: 'mcq', category: 'new', question: 'How should "volume" be abbreviated in IEEE references?', options: ['v.', 'vol.', 'volume', 'Vol'], correct: 1 },
    { id: 264, type: 'mcq', category: 'new', question: 'How should "number" (issue) be abbreviated in IEEE references?', options: ['num.', 'n.', 'no.', 'number'], correct: 2 },
    { id: 265, type: 'mcq', category: 'new', question: 'What does "ed." stand for in IEEE book references?', options: ['Editor', 'Edition', 'Educational', 'Edited'], correct: 1 },
    // Copyright and Licensing Concepts
    { id: 266, type: 'mcq', category: 'new', question: 'What is the main difference between traditional and Open Access publishing?', options: ['Quality of papers', 'Reader access cost', 'Number of citations', 'Publication speed'], correct: 1 },
    { id: 267, type: 'mcq', category: 'new', question: 'Who typically owns the copyright after traditional journal publication?', options: ['The author completely', 'The university', 'The journal/publisher', 'Public domain'], correct: 2 },
    { id: 268, type: 'mcq', category: 'new', question: 'What does CC-BY license allow?', options: ['No reuse', 'Commercial and non-commercial reuse with attribution', 'Only personal use', 'Only educational use'], correct: 1 },
    { id: 269, type: 'mcq', category: 'new', question: 'What does the "NC" in CC-BY-NC mean?', options: ['Not Cited', 'New Copyright', 'Non-Commercial', 'Not Copied'], correct: 2 },
    // Journal Selection and Quality
    { id: 270, type: 'mcq', category: 'new', question: 'What should be the primary consideration when selecting a journal?', options: ['Fastest publication time', 'Lowest fees', 'Journal quality and metrics', 'Easiest acceptance'], correct: 2 },
    { id: 271, type: 'mcq', category: 'new', question: 'Why is it important to publish in indexed journals?', options: ['They are cheaper', 'They are faster', 'They are trusted and recognized', 'They accept all papers'], correct: 2 },
    { id: 272, type: 'mcq', category: 'new', question: 'What does a higher Impact Factor generally indicate?', options: ['Older journal', 'More influential journal', 'Cheaper journal', 'Easier acceptance'], correct: 1 },
    { id: 273, type: 'mcq', category: 'new', question: 'Which quartile indicates the lowest quality journals?', options: ['Q1', 'Q2', 'Q3', 'Q4'], correct: 3 },
    // Biography Writing Details
    { id: 274, type: 'mcq', category: 'new', question: 'Should personal hobbies be included in an academic biography?', options: ['Yes, always', 'No, keep it professional', 'Only if related to research', 'Only for senior professors'], correct: 1 },
    { id: 275, type: 'mcq', category: 'new', question: 'What degree should typically be mentioned in a biography?', options: ['High school diploma', 'Bachelor\'s degree only', 'Highest degree (usually Ph.D.)', 'All degrees'], correct: 2 },
    { id: 276, type: 'mcq', category: 'new', question: 'Should the year of degree completion be mentioned?', options: ['Never', 'Yes, typically included', 'Only if recent', 'Only if more than 10 years ago'], correct: 1 },
    { id: 277, type: 'mcq', category: 'new', question: 'What type of position information should be included?', options: ['All previous positions', 'Current position', 'Future positions', 'Part-time jobs'], correct: 1 },
    // Ethics Details
    { id: 278, type: 'mcq', category: 'new', question: 'What is considered plagiarism?', options: ['Citing other authors', 'Using others\' work without proper credit', 'Reading other papers', 'Building on previous research'], correct: 1 },
    { id: 279, type: 'mcq', category: 'new', question: 'What should you do with contributors who made real contributions?', options: ['Ignore them', 'Thank them in acknowledgments', 'Include them as authors', 'Mention them in references'], correct: 2 },
    { id: 280, type: 'mcq', category: 'new', question: 'Why is self-citation abuse problematic?', options: ['It artificially inflates citation metrics', 'It shows expertise', 'It demonstrates productivity', 'It helps readers'], correct: 0 },
    { id: 281, type: 'mcq', category: 'new', question: 'What characterizes a "trusted" journal?', options: ['High acceptance rate', 'Fast publication', 'Proper indexing and peer review', 'Low fees'], correct: 2 },
    // More on Reference Structure
    { id: 282, type: 'mcq', category: 'new', question: 'In what order should multiple authors be listed in IEEE format?', options: ['Alphabetically', 'By contribution level', 'As they appear on the original paper', 'By institution'], correct: 2 },
    { id: 283, type: 'mcq', category: 'new', question: 'How many authors should be listed before using "et al." in IEEE?', options: ['1', '3', '5', 'IEEE typically lists all authors'], correct: 3 },
    { id: 284, type: 'mcq', category: 'new', question: 'Where should the DOI be placed if included?', options: ['At the beginning', 'After the author', 'At the end of the reference', 'DOI is not used in IEEE'], correct: 2 },
    { id: 285, type: 'mcq', category: 'new', question: 'Should URLs be underlined in IEEE references?', options: ['Yes, always', 'No, never', 'Only for websites', 'Only for books'], correct: 1 },
    // More on Journal Metrics
    { id: 286, type: 'mcq', category: 'new', question: 'How is Impact Factor typically calculated?', options: ['Total papers divided by citations', 'Citations in last 2 years divided by papers published in those years', 'Total citations ever', 'Number of submissions'], correct: 1 },
    { id: 287, type: 'mcq', category: 'new', question: 'Can a journal be in Q1 in one database and Q2 in another?', options: ['No, rankings are universal', 'Yes, different databases use different methods', 'Only if it\'s a new journal', 'Only for multidisciplinary journals'], correct: 1 },
    { id: 288, type: 'mcq', category: 'new', question: 'What time period does Impact Factor typically cover?', options: ['1 year', '2 years', '5 years', '10 years'], correct: 1 },
    { id: 289, type: 'mcq', category: 'new', question: 'Is a higher quartile number better or worse?', options: ['Higher is better (Q4 is best)', 'Lower is better (Q1 is best)', 'All quartiles are equal', 'It depends on the field'], correct: 1 },
    // Conference vs Journal References
    { id: 290, type: 'mcq', category: 'new', question: 'What is the key phrase that distinguishes a conference reference?', options: ['"published in"', '"in Proc."', '"at conference"', '"presented at"'], correct: 1 },
    { id: 291, type: 'mcq', category: 'new', question: 'Should the conference location be included in IEEE format?', options: ['No, never', 'Yes, city and sometimes country', 'Only country', 'Only for international conferences'], correct: 1 },
    { id: 292, type: 'mcq', category: 'new', question: 'Do conference papers include volume and issue numbers?', options: ['Yes, always', 'No, typically just page numbers', 'Only volume', 'Only issue'], correct: 1 },
    // More Copyright Questions
    { id: 293, type: 'mcq', category: 'new', question: 'Can you post your published IEEE paper on your personal website?', options: ['No, never', 'Yes, the final published version freely', 'Only preprint versions typically', 'Only with paid subscription'], correct: 2 },
    { id: 294, type: 'mcq', category: 'new', question: 'What is an "Author Gateway"?', options: ['Physical entrance to IEEE', 'Online portal for author services', 'Email system', 'Conference registration'], correct: 1 },
    { id: 295, type: 'mcq', category: 'new', question: 'Can you use your published paper for teaching?', options: ['No', 'Yes, personal use is typically permitted', 'Only with permission', 'Only paid courses'], correct: 1 },
    // Lecture 7 Questions
    { id: 296, type: 'mcq', category: 'new', question: 'What does the Arabic text in Lecture 7 advise about?', options: ['Use terms and abbreviations freely', 'Avoid using terms and abbreviations', 'Only use English terms', 'Create new abbreviations'], correct: 1 },
    { id: 297, type: 'mcq', category: 'new', question: 'Based on Lecture 7\'s main visible instruction, what should be minimized in scientific writing?', options: ['References', 'Equations', 'Terms and abbreviations', 'Figures'], correct: 2 },
    { id: 298, type: 'mcq', category: 'new', question: 'What language is primarily used in the Lecture 7 content shown?', options: ['English only', 'Arabic only', 'English with some Arabic', 'Arabic with some English'], correct: 2 },
    { id: 299, type: 'mcq', category: 'new', question: 'What is the lecture number of the second document?', options: ['Lecture 5', 'Lecture 6', 'Lecture 7', 'Lecture 8'], correct: 2 },
    { id: 300, type: 'mcq', category: 'new', question: 'Who is the instructor for both lectures?', options: ['Prof. Anwer Sayed', 'Asocc. Prof. Anwer Sayed', 'Dr. Anwer Sayed', 'Eng. Anwer Sayed'], correct: 1 },
    // Additional Comprehensive Questions
    { id: 301, type: 'mcq', category: 'new', question: 'What should hanging indent format achieve in a reference list?', options: ['Makes first line longer', 'Makes subsequent lines indented', 'Centers all text', 'Right-aligns text'], correct: 1 },
    { id: 302, type: 'mcq', category: 'new', question: 'Why is consistency important in reference formatting?', options: ['Looks professional and aids readability', 'Increases citations', 'Reduces file size', 'Speeds up publication'], correct: 0 },
    { id: 303, type: 'mcq', category: 'new', question: 'What is the purpose of IEEE membership designation in biographies?', options: ['Shows status and involvement in professional community', 'Required for publication', 'Increases citations', 'Reduces publication fees'], correct: 0 },
    { id: 304, type: 'mcq', category: 'new', question: 'Can you republish your IEEE paper in another journal?', options: ['Yes, freely', 'No, copyright was transferred', 'Only in non-English journals', 'Only after 10 years'], correct: 1 },
    { id: 305, type: 'mcq', category: 'new', question: 'What does "indexed journal" mean?', options: ['Has an index at the back', 'Listed in recognized academic databases', 'Published monthly', 'Has many editors'], correct: 1 },
    { id: 306, type: 'mcq', category: 'new', question: 'Why does IEEE use numbered citations instead of author-year?', options: ['Saves space and keeps text flowing', 'Easier to remember', 'Required by law', 'Reduces plagiarism'], correct: 0 },
    { id: 307, type: 'mcq', category: 'new', question: 'Should you cite papers you haven\'t read?', options: ['Yes, if they seem relevant', 'No, only cite what you\'ve actually read', 'Yes, if they have high citations', 'No difference'], correct: 1 },
    { id: 308, type: 'mcq', category: 'new', question: 'What happens if references are not in order of citation?', options: ['Nothing', 'It violates IEEE format requirements', 'Increases citations', 'Improves readability'], correct: 1 },
    { id: 309, type: 'mcq', category: 'new', question: 'Can figures be included in author biographies?', options: ['No', 'Yes, typically a photo', 'Only for senior authors', 'Only in conference papers'], correct: 1 },
    { id: 310, type: 'mcq', category: 'new', question: 'What is the main goal of journal metrics?', options: ['Measure journal quality and influence', 'Calculate subscription fees', 'Determine page limits', 'Set acceptance rates'], correct: 0 },
    { id: 311, type: 'mcq', category: 'new', question: 'Should abbreviations be defined when first used in a paper?', options: ['No, readers should know them', 'Yes, typically defined at first use', 'Only uncommon ones', 'Never define abbreviations'], correct: 1 },
    { id: 312, type: 'mcq', category: 'new', question: 'What information does SJR provide that IF doesn\'t emphasize as much?', options: ['Number of papers', 'Prestige/quality of citing journals', 'Acceptance rate', 'Publication speed'], correct: 1 },
    { id: 313, type: 'mcq', category: 'new', question: 'Can the same paper be submitted to multiple journals simultaneously?', options: ['Yes, to increase chances', 'No, this is unethical', 'Only to conferences', 'Only with permission'], correct: 1 },
    { id: 314, type: 'mcq', category: 'new', question: 'What should be done if an error is found after publication?', options: ['Ignore it', 'Submit correction/erratum to journal', 'Republish elsewhere', 'Delete the paper'], correct: 1 },
    { id: 315, type: 'mcq', category: 'new', question: 'Are conference papers peer-reviewed?', options: ['Never', 'Usually yes', 'Only keynote papers', 'Only in IEEE conferences'], correct: 1 },
    { id: 316, type: 'mcq', category: 'new', question: 'What is the difference between CC-BY and CC-BY-NC?', options: ['Number of authors', 'Commercial use permission', 'Citation requirements', 'Geographic restrictions'], correct: 1 },
    { id: 317, type: 'mcq', category: 'new', question: 'Should funding sources be acknowledged in papers?', options: ['No, keep them secret', 'Yes, for transparency', 'Only if required', 'Only for large grants'], correct: 1 },
    { id: 318, type: 'mcq', category: 'new', question: 'What is a preprint?', options: ['Draft before peer review', 'Final published version', 'Conference presentation', 'Rejected paper'], correct: 0 },
    { id: 319, type: 'mcq', category: 'new', question: 'Can you cite preprints in IEEE papers?', options: ['Never allowed', 'Yes, but note they are preprints', 'Only from arXiv', 'Only your own'], correct: 1 },
    { id: 320, type: 'mcq', category: 'new', question: 'What does "peer review" mean?', options: ['Friends reviewing the paper', 'Experts in the field evaluate the paper', 'Editor reads the paper', 'Automatic software check'], correct: 1 },
    { id: 321, type: 'mcq', category: 'new', question: 'How long is a typical peer review process?', options: ['1 day', 'Weeks to months', 'Years', 'Hours'], correct: 1 },
    { id: 322, type: 'mcq', category: 'new', question: 'Can you be a reviewer for a journal you\'ve published in?', options: ['No, conflict of interest', 'Yes, if invited and qualified', 'Only after 5 years', 'Only for different topics'], correct: 1 },
    { id: 323, type: 'mcq', category: 'new', question: 'What should you do if you disagree with reviewer comments?', options: ['Ignore them', 'Respond professionally with justification', 'Withdraw paper', 'Complain to editor'], correct: 1 },
    { id: 324, type: 'mcq', category: 'new', question: 'Can tables and figures be cited from other papers?', options: ['No, never', 'Yes, with proper citation and permission', 'Only from open access', 'Only if modified'], correct: 1 },
    { id: 325, type: 'mcq', category: 'new', question: 'What is "article in press"?', options: ['Rejected paper', 'Accepted but not yet published', 'Under review', 'Retracted paper'], correct: 1 },
    { id: 326, type: 'mcq', category: 'new', question: 'Should you cite your own previous work?', options: ['Never, it\'s self-citation', 'Yes, when relevant', 'Only if asked by reviewers', 'Only in introduction'], correct: 1 },
    { id: 327, type: 'mcq', category: 'new', question: 'What is a DOI?', options: ['Date of Issue', 'Digital Object Identifier', 'Document Online Index', 'Database of Information'], correct: 1 },
    { id: 328, type: 'mcq', category: 'new', question: 'Are all Q1 journals equally good?', options: ['Yes, exactly the same', 'No, there\'s variation within Q1', 'Only in same field', 'Only IEEE journals'], correct: 1 },
    { id: 329, type: 'mcq', category: 'new', question: 'Can you publish the same work in a journal and conference?', options: ['Yes, identical versions', 'Generally no, or with significant differences', 'Only in IEEE', 'Only if invited'], correct: 1 },
    { id: 330, type: 'mcq', category: 'new', question: 'What is "acceptance rate"?', options: ['How fast papers are accepted', 'Percentage of submitted papers accepted', 'Number of citations', 'Impact factor'], correct: 1 },
    { id: 331, type: 'mcq', category: 'new', question: 'Is lower or higher acceptance rate generally better for journal prestige?', options: ['Higher is better', 'Lower is better (more selective)', 'No relationship', 'Depends on field'], correct: 1 },
    { id: 332, type: 'mcq', category: 'new', question: 'What should you do if you find plagiarism in a published paper?', options: ['Ignore it', 'Report to journal editor', 'Confront author directly', 'Share on social media'], correct: 1 },
    { id: 333, type: 'mcq', category: 'new', question: 'Can you withdraw a paper after submission?', options: ['Never', 'Yes, before acceptance usually', 'Only if you pay', 'Only within 24 hours'], correct: 1 },
    { id: 334, type: 'mcq', category: 'new', question: 'What is a "corresponding author"?', options: ['Author who writes letters', 'Main contact person for the paper', 'First author always', 'Author who does correspondence review'], correct: 1 },
    { id: 335, type: 'mcq', category: 'new', question: 'Should all authors approve the final manuscript?', options: ['No, only first author', 'Yes, all authors should approve', 'Only corresponding author', 'Only senior authors'], correct: 1 },
    { id: 336, type: 'mcq', category: 'new', question: 'What is an "editorial"?', options: ['Spelling corrections', 'Opinion piece by editor', 'Research article', 'Book review'], correct: 1 },
    { id: 337, type: 'mcq', category: 'new', question: 'Can undergraduate students be authors on papers?', options: ['Never', 'Yes, if they made real contributions', 'Only as last author', 'Only in student journals'], correct: 1 },
    { id: 338, type: 'mcq', category: 'new', question: 'What is a "letter to editor"?', options: ['Personal correspondence', 'Short communication or comment on published work', 'Cover letter', 'Complaint'], correct: 1 },
    { id: 339, type: 'mcq', category: 'new', question: 'Should you cite papers in languages you don\'t read?', options: ['Yes, always', 'Ideally read translations or get help', 'Only if highly cited', 'Never'], correct: 1 },
    { id: 340, type: 'mcq', category: 'new', question: 'What is a "retraction"?', options: ['Paper correction', 'Paper withdrawn due to serious issues', 'Paper update', 'Paper translation'], correct: 1 },
    { id: 341, type: 'mcq', category: 'new', question: 'Can ethical violations lead to retraction?', options: ['No', 'Yes, serious violations can', 'Only for plagiarism', 'Only in medical journals'], correct: 1 },
    { id: 342, type: 'mcq', category: 'new', question: 'What is an "embargo period"?', options: ['Time before publication', 'Period when content can\'t be shared publicly', 'Review period', 'Subscription period'], correct: 1 },
    { id: 343, type: 'mcq', category: 'new', question: 'Can you share your paper on ResearchGate?', options: ['No, never', 'Depends on publisher\'s policy', 'Only abstracts', 'Only after 5 years'], correct: 1 },
    { id: 344, type: 'mcq', category: 'new', question: 'What is a "special issue"?', options: ['Emergency publication', 'Focused collection on specific topic', 'First issue of journal', 'Free issue'], correct: 1 },
    { id: 345, type: 'mcq', category: 'new', question: 'Can guest editors handle special issues?', options: ['No, only regular editors', 'Yes, experts invited for specific topics', 'Only in conferences', 'Only in open access'], correct: 1 },
    { id: 346, type: 'mcq', category: 'new', question: 'What is "publication ethics"?', options: ['Cost of publishing', 'Standards and conduct in research publication', 'Journal formatting rules', 'Citation styles'], correct: 1 },
    { id: 347, type: 'mcq', category: 'new', question: 'What is COPE?', options: ['Copyright Office for Publications', 'Committee on Publication Ethics', 'Conference on Publishing Excellence', 'Council of Paper Editors'], correct: 1 },
    { id: 348, type: 'mcq', category: 'new', question: 'Should authorship order be decided early?', options: ['No, after publication', 'Yes, to avoid conflicts', 'Only for student papers', 'Editor decides'], correct: 1 },
    { id: 349, type: 'mcq', category: 'new', question: 'What is "ghost authorship"?', options: ['Anonymous author', 'Someone wrote but isn\'t credited', 'Deceased author', 'Pseudonym use'], correct: 1 },
    { id: 350, type: 'mcq', category: 'new', question: 'What is "gift authorship"?', options: ['Free publication', 'Author credit without real contribution', 'Mentoring credit', 'Honorary degree'], correct: 1 },
    // Poster Questions
    // What is a Poster?
